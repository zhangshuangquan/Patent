...
SplitPage.prototype = {
    ...
    setLinks : function(){
        ...
        if(this.showTotalPage=="YES"){
        	links +="共"+this.totalNum+"页&nbsp;&nbsp;";
        }
        if(this.showGoPage=="YES") {
            links += "去第 <div class='page_go_cont'><input type='input' min='1' max="+this.totalNum+" class='pageIndex' /><a href='javascript:;' class='page_go'>确定</a></div> 页";
        }
